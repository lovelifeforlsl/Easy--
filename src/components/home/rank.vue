<template>
  <div>
    ...
    <div class="books-list-item" v-for="(item,index) in swdata" :key="index" @click="godatails(item)">
      <div class="content">
        <div class="imgbox">
      ...
      <div class="listcont">
        <div class="books-list-item-title" v-for="(item,index) in listdata" :key="index">
