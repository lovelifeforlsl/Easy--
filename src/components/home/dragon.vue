  ...
  <div>
    ...
    <div class="books-group">
      <ul class="swiper-wrapper">
        <li class="swiper-slide" v-for="(item,index) in swdata" :key="index" @click="godatails(item)">
          <div class="book-img">
    ...
    <!-- 列板 -->
    <div class="books-list-item" v-for="(item,index) in listdata" :key="index"  @click="godatails(item)">
        <!-- tips -->
...
export default {
  ...
  watch: {
    id: function(newval) {
      ...
      this.$axios({
        method: "GET",
        url: `/book/by-categories?gender=male&type=hot&major=${this.id}`,
        params: {
          minor: "",
          start: this.start,
          limit: this.count
